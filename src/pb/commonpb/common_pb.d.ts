...
export class Process extends jspb.Message {
  ...
  clearCmdlineList(): void;
  getCmdlineList(): Array<string>;
  setCmdlineList(value: Array<string>): void;
  addCmdline(value: string, index?: number): string;
